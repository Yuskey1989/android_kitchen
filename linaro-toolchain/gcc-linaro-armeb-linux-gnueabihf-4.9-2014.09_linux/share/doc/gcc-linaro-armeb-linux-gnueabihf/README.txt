 ...
 * A statically linked gdbserver in armeb-linux-gnueabihf/debug-root
 * A system root
...
--------------------
The armeb-linux-gnueabihf version targets the Linaro Evaluation Build
...
The sysroot is gcc-linaro-../armeb-linux-gnueabihf/libc
 ...
 * Run `make -f contrib/linaro/build.mk TARGETS=armeb-linux-gnueabihf`
